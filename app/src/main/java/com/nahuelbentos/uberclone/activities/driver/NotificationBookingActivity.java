...
public class NotificationBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mExtraDuration = getIntent().getStringExtra("min");
        ...
        mTextViewMin.setText(mExtraDuration);
        mTextViewDistance.setText(mExtraDistance);
        mMediaPlayer = MediaPlayer.create(this, R.raw.rigntone);
    ...
    public void checkIfClientCancelBooking(){
    ...
    private void cancelBooking() {
        ...
        mClientBookingProvider.updateStatus(mExtraIdClient, "cancelled");
    ...
    private void acceptBooking() {
        ...
        mClientBookingProvider = new ClientBookingProvider();
        mClientBookingProvider.updateStatus(mExtraIdClient, "accepted");
